                ...
                <div class="row main-row" id="member-row">
                    <div class=" col-8 col-12-medium" id="member-int">
                        <div class="row">
                            ...
                            <div class="col-9 col-12-medium">
                                <ul class="list-unstyled">
                                    <li class="name">王曉明</li>
                                    <li style="font-size: 18px;">會員ID: 00000446</li>
                                </ul>
                            </div>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="member-case">
                            <div class="card-list">
                                <a href="/rescue.html" class="card-a">
                                    <div class="card-box">
                                        <div class="number">
                                            3
                                        </div>
                            ...
                            <div class="card-list">
                                ...
                                <a href="/adopt.html" class="card-a">
                                    <div class="card-box">
                                        <div class="number">
                                            1
                                        </div>
                            ...
                            <div class="card-list">
                                ...
                                <a href="/stray.html" class="card-a">
                                    <div class="card-box">
                                        <div class="number">
                                            1
                                        </div>
