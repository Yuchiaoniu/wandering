...
if(isset($_POST['img'])){
  ...
  $upload = $_FILES['upload'];
    ...
    //執行 SQL 命令，新增此帳號
    $sql = "INSERT INTO stray (title, type, nickname, city, town, address, chip, ligation, ear, appearance , contact, detail, img ) 
			VALUES ('$title', '$type', '$nickname', '$city', '$town', '$address', 
              '$chip', '$ligation', '$ear', 
