									...
									<div class="row g-0">
										<div class="col-md-4">
											<a href="rescue_Detail_1.html">
												<img src="/images/rescue1.png" type="button"
										...
										<div class="col-md-8">
											<div class="card-body">
												...
												<a href="/rescue_Detail_1.html">
													<h5 class="card-title">南投草屯受傷的流浪狗</h5>
												</a>
												<h4>
													<div class="title">救援案件編號： R164534225182</div>
												</h4>
												<div class="datecreate mb-1">
													<h4 class="date-title">建立日期：2022-02-20</h4>
													<b class="card-text">
														動物類別： 狗<br>
														動物數量： 1
													</b>
									...
									<div class="row g-0">
										...
										<div class="col-md-8">
											<div class="card-body">
												...
												<a href="/rescue_Detail_2.html">
													<h5 class="card-title">2/10晚上在中興大學附近撿到親人品種貓</h5>
												</a>
												<h4>
