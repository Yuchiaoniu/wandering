                    ...
                    <div class="row main-row" id="member-row">
                        <div class=" col-8 col-12-medium" id="member-int" style="padding-left: 0px;">
                            ...
                            ?>
                                ...
                                <form class="input" name="myForm" method="post" action="editdel.php">
                                        <input name="test" type="text" value="<?php echo $row['id'] ?>" style="display: none;">
                                        <input name="btn" type="button" onclick="check_data(<?php echo $row2['id']?>)" value="我要認養" class="btn btn-primary"
