                ...
                <div class="row main-row">
                    ...
                    <div class="col-9 col-12-medium">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo $row['type'];
                            echo '</span> <br><br>';
                            echo "動物名稱：" . $row['name'] . "<br><br>";
                            echo "縣市鄉鎮區：" . $row['address'] . "<br><br>";
                            echo "動物性別：" . $row['gender'] . "<br><br>";
                            echo "有無晶片：" . $row['chip'] . "<br><br>";
                            echo "剪耳狀態：" . $row['ear'] . "<br><br>";

                            echo "<br></li></ul></section><hr>" ;
                            //// 上半部END
                            ...
                            echo '<div class="panel-heading">';
                            echo '<h4 class="panel-title">';
                            echo '	<a data-toggle="collapse" data-parent="#accordion" href="#collapsefive">';
                            echo '領養條件方式</a></h4></div>';

                            echo '<div id="collapsefive" class="panel-collapse collapse">';
                            echo '<div class="panel-body">';
                            echo $row['adoptreason'];
                            echo '</div></div>';
                        }
